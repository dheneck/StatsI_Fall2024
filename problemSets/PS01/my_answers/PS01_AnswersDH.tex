...
\begin{document}
	...
	\begin{enumerate}
		...
		\lstinputlisting[language=R, firstline=41, lastline=54]{Daniel_Heneck_PS1.R}
		\begin{Verbatim}
			90% CI = [93.95,102.92]
		\end{Verbatim}
		\noindent
	...
	\end{enumerate}
	\lstinputlisting[language=R, firstline=57, lastline=74]{Daniel_Heneck_PS1.R}
	\begin{Verbatim}
			       P-Value = 0.72
	\end{Verbatim}
	Conclusion: 
	...
	\vspace{.5cm}
			\lstinputlisting[language=R, firstline=82, lastline=86]{Daniel_Heneck_PS1.R}
